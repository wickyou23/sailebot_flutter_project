...
import 'package:sailebot_app/frameworks/linkedin_login/helper/global_variables.dart';
import 'package:sailebot_app/frameworks/linkedin_login/helper/helper_methods.dart';
  ...
  Future<LinkedInTokenObject> _getUserProfile(
    ...
    if (response.statusCode == HttpStatus.ok) {
      return LinkedInTokenObject(
        accessToken: json.decode(response.data)['access_token'].toString(),
        expiresIn: json.decode(response.data)['expires_in'],
      );
    } else {
      return LinkedInTokenObject(
